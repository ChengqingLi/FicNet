...
def setup_run(arg_mode='train'):
    ...
    args.save_path = os.path.join('checkpoints/{}/{}shot-{}way/'.format(args.dataset,args.shot,args.way), args.extra_dir)
    ...
    #                config=args,
    #                save_code=True,
    #                name=args.extra_dir,entity='99ergao')
...
def by(s):
    ...
    :rtype: str
    '''
    bold = '\033[1m' + '{:.3f}'.format(s) + '\033[0m'
...
def parse_args(arg_mode):
    ...
    parser.add_argument('-dataset', type=str, default='car',
                        choices=['miniimagenet', 'cub', "dog",'car'])
    ...
    #parser.add_argument('-shot_train', type=int, default=5, metavar='K', help='number of shots')
    ...
    parser.add_argument('-test_episode', type=int, default=1200, help='number of testing episodes after training')

    ''' about MFN '''
    parser.add_argument('-self_method', type=str, default='mfn')
